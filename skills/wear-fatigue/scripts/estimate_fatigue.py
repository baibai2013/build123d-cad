...
from wear_common import evaluate_project, fatigue_report, maintenance_markdown, project_path, reports_dir, summary_markdown, write_json, write_text


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Estimate robot-dog fatigue and bearing-life risks.")
    ...
    report = fatigue_report(payload)
    out_dir = reports_dir(project_dir)
    write_json(out_dir / "fatigue_report.json", report)
