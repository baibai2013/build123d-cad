...
name: build123d-cad
description: |
  硬件设计 Super Skill。一个父技能内含 19 个子技能（mechanical / viewer / urdf /
  ...
  gait-optimization / fea / robot-dog-digital-twin），
  ...
  电源预算、电路保护、热风险、步态优化、行走算法、FEA、结构强度、刚度、数字孪生、虚拟样机、机械狗验证、
  设计评分、实体样机 gate。
