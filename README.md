...
融合 CadQuery 创始人 Dave Cowden 的建模哲学和 Peter Corke 的运动仿真哲学，<br>
基于 build123d API 全量梳理、25+ 真实案例（零件/装配/曲面/关节/安装/仿真）、8 大类参考文档，<br>
提炼 5 个核心心智模型、8 条代码质量启发式和完整的 CAD 代码生成工作流。<br>
覆盖零件建模、装配流、OCP 可视化、制造工艺、Dave Cowden 哲学、验证方法、<br>
